...
// ReRegister is called when master fails and another master takes its place
func (wk *Worker) ReRegister(args *ReRegisterArgs, _ *struct{}) error {
	fmt.Printf("ReRegistering %s\n", wk.name)
	
	wk.register(args.Master)
	return nil
}
